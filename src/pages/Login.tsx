              ...
              <IonCardContent>
                <form onSubmit={doLogin}>
                  <IonInput
                    ...
                    label="Email"
                    type="email"
                    placeholder="HannaFrangi.hf@gmail.com"
                  ></IonInput>
                  <IonInput
                    mode="md"
                  ...
                  <IonButton
                    ...
                    className="ion-margin-top"
                  >
                    Weather <IonIcon icon={cloudCircleOutline} slot="end" />
                  </IonButton>
                  <IonButton
                    shape="round"
                  ...
                  <IonButton
                    ...
                    className="ion-margin-top"
                  >
                    Test <IonIcon icon={iceCream} slot="end" />{" "}
                  </IonButton>
                  <IonButton
                    shape="round"
                    routerLink="/Qrcode"
                    ...
                    className="ion-margin-top"
                  >
                    Qr Code <IonIcon icon={qrCodeOutline} slot="end" />
                  </IonButton>
                </form>
              </IonCardContent>
